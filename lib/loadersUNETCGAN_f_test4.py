...
class RadioUNet_s(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.fix_samples ==4:
            # 655*0.8 = 524 , 655*0.2 = 131
            x_samples = np.append(np.random.randint(0,128,size=524),np.random.randint(128,255,size=131))
            y_samples = np.random.randint(0,255,size=655)
